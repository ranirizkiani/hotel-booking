...
const Header: React.FC<TypeHeader> = (props: TypeHeader) => (
    <header className={styleClasses['header']}>
        <div className={styleClasses['header__logo']}>
            <span className={styleClasses['header__logo__title']}>Made and modified by rani rizkiani</span>
            <span className={styleClasses['header__logo__slogan']}>Hotel Booking System</span>
        </div>
        {props.activeStep !== 0 && (
